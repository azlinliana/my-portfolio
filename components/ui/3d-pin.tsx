...
export const PinContainer = ({
  ...
  return (
    <a
      ...
      className={cn(
        "relative flex items-center justify-center overflow-hidden rounded-xl cursor-pointer group/pin",
        containerClassName
      )}
    >
      ...
      <div style={{ perspective: "1000px" }} className="w-full h-full">
        <div
          ...
          className={cn(
            "w-full h-full rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-zinc-900 border border-white/[0.1] group-hover/pin:border-white/[0.2]",
            className
          )}
        >
          {children}
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-900 py-0.5 px-4 ring-1 ring-white/10 ">
            <span
            ...
            <span
              className="absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] bg-gradient-to-r from-purple-400/0 via-purple-400/90 to-purple-400/0 transition-opacity duration-500 group-hover/btn:opacity-40"></span>
          </a>
        </div>
